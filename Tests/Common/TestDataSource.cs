...
namespace Tests.Common
{
    public class TestDataSource
    {
        ...
        {
            var source = new DataSource().Add("1 2 3 4").Add("5 6 7 8");
        ...
        {
            var source = new DataSource().Add("1 2 3 4").Add("5 6 7 8");
            var failedSource = new DataSource().Add("1 2 3 4").Add("5 6 7 8 9");
            var successSource = new DataSource().Add("1 2 3 4").Add("5 6 7 8");
